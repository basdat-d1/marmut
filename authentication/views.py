...
#       response.set_cookie("registered_as", "pengguna")

#       if is_premium(cursor, email):
#         context['is_premium'] = True
#         response.set_cookie["is_premium"] = True
#     elif user_label:
#       request.session["registered_as"] = "label"
#       response.set_cookie("registered_as", "label")
...
#       cursor.execute(f"SELECT * FROM ARTIST WHERE email = '{email}'")
#       artist = cursor.fetchone()
#       cursor.execute(f"SELECT * FROM SONGWRITER WHERE email = '{email}'")
#       songwriter = cursor.fetchone()
#       cursor.execute(f"SELECT * FROM PODCASTER WHERE email = '{email}'")
#       podcaster = cursor.fetchone()
      
#       if artist:
#         response.set_cookie('is_artist', True)
#       if songwriter:
#         response.set_cookie('is_songwriter', True)
#       if podcaster:
#         response.set_cookie('is_podcaster', True)
#       print (response)
#       return response
